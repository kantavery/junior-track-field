...
const MEETS = [
  {
    ...
    desc: "第2支部の春シーズン最初の競技会。年度初めの記録確認に使いやすい大会です。エントリーはJAAF athleticfamilyから。",
  ...
  },
  {
    ...
    venue: "スピアーズえどりくフィールド（江戸川区陸上競技場）",
    desc: "第2支部の予選大会。春から初夏の東京都大会につながる重要な大会です。エントリーはJAAF athleticfamilyから。",
  ...
  {
    id: "branch2-gakunen", cat: "第2支部", season: "春",
    title: "第2支部学年別陸上競技大会",
    dates: "5/30(土)・5/31(日)", start: "20260530", end: "20260601",
    venue: "スピアーズえどりくフィールド（江戸川区陸上競技場）",
    desc: "第2支部の学年別大会。学年ごとに記録を競います。エントリーはJAAF athleticfamilyから。",
    ...
    results: "http://www.tokyokotairenrikujo.jp/branch23/2026/SL/03_gakunen/kyougi.html",
  },
  {
    ...
    venue: "スピアーズえどりくフィールド（江戸川区陸上競技場）",
    desc: "夏休み期間の第2支部競技会。秋の大会に向けた記録確認にも使いやすい大会です。エントリーはJAAF athleticfamilyから。",
  ...
  },
  {
    ...
    venue: "スピアーズえどりくフィールド（江戸川区陸上競技場）",
    desc: "第2支部の新人大会。秋の新人戦シーズンにつながる大会です。エントリーはJAAF athleticfamilyから。",
  ...
  },
  {
    ...
    venue: "夢の島競技場",
    desc: "第2支部の秋季競技会。秋季は雨天決行で実施されます。エントリーはJAAF athleticfamilyから。",
  ...
  },
  {
    ...
    title: "第2支部新春駅伝大会",
    dates: "2027/1/16(土)", start: "20270116", end: "20270117",
    venue: "会場は要項で確認",
    desc: "第2支部の冬季駅伝大会。雨天決行で実施されます。エントリーシートは支部ページから。",
